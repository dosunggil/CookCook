...
<link  href="${rootPath}/resources/css/main.css" rel="stylesheet" />
...
<script src="${rootPath}/resources/js/home.js?ver-002"></script>
<script src="${rootPath}/resources/js/log.js?ver-002"></script>
