...
<script src="${rootPath}/resources/js/cho/recipe/recipe_update.js?ver-019"></script>
<script src="${rootPath}/resources/js/cho/recipe/insertAndupdate.js?ver-019"></script>
